...
ShoppingCartAction.addGoodsToShoppingCartLS = function(p0, p1, p2, callback) {
  dwr.engine._execute(ShoppingCartAction._path, 'ShoppingCartAction', 'addGoodsToShoppingCartLS', p0, p1, p2, callback);
}
